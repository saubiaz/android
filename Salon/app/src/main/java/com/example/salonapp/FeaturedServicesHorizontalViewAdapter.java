...
public class FeaturedServicesHorizontalViewAdapter extends RecyclerView.Adapter<FeaturedServicesHorizontalViewAdapter.ViewHolder> {
    ...
    public FeaturedServicesHorizontalViewAdapter(Context context,  LayoutOptions[] layoutOptions) {
    ...
    @NonNull
    @Override
    public FeaturedServicesHorizontalViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.activity_featured_horizontal_layout_list_options, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.featuredIitem.setText(layoutOption.getName());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView featuredIitem;
        ImageView imgViewIcon;
        private ItemClickListener mClickListener;

        ViewHolder(View itemView) {
            super(itemView);
            featuredIitem = itemView.findViewById(R.id.featured_item);
            imgViewIcon = itemView.findViewById(R.id.featured_item_image);
